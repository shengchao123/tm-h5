      ...
      <div class="pt24 pl32 pr32 pb32">
        ...
        <div class="center mt48">
          <div class="pop-btn mr24"
               v-clipboard:copy="popData.contactEmail"
               v-clipboard:success="(type) => copyEmail('success')"
               v-clipboard:error="(type) => copyEmail('error')">复制邮箱</div>
          <div class="pop-btn"
               @click="callPhone(popData.contactPhone)">拨打电话</div>
        </div>
      </div>
    </u-popup>
  </div>
