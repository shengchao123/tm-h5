...
/* harmony import */ var _Map_vue_vue_type_template_id_2a470c08_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Map.vue?vue&type=template&id=2a470c08&scoped=true& */ 188);
/* harmony import */ var _Map_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Map.vue?vue&type=script&lang=js& */ 190);
...
/* harmony import */ var _Map_vue_vue_type_style_index_0_id_2a470c08_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Map.vue?vue&type=style&index=0&id=2a470c08&lang=scss&scoped=true& */ 192);
  ...
  methods: {
    ...
    drawMarker: function drawMarker() {
      ...
      var Icon = new _AMap.default.Icon({
        ...
        image: __webpack_require__(/*! @/static/map/travel_mark.png */ 101),
      ...
      this.points.forEach(function (item, index) {
        ...
        var indexText = "<div style=\"color:#ffffff;width:22px;text-align:center;margin-top:2px;font-size:11px\">".concat(index + 1, "</div>"); // eslint-disable-next-line no-new
        ...
        marker.on('click', _this.markerClick); // AMap.event.addListener(marker, 'click', this.markerClick)
      });
    },
